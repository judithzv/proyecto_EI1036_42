...
<div id="mincontainer">
	...
	<form class="fom_usuario" action="?action=pagar" method="POST">
		...
		<br/>
		<input type="text" name="numero" class="item_requerid" size="20" maxlength="40" oninput="validar(this)">
		<br/>
        <label for="mes" class="fa fa-calendar-o"><b> Mes de vencimiento</b></label>
		<br/>
		<input type="text" name="mes" class="item_requerid" size="20" maxlength="40" oninput="validar(this)">
		<br/>
        <label for="año" class="fa fa-calendar"" ><b> Año de vencimiento</b></label>
		<br/>
		<input type="text" name="año" class="item_requerid" size="20" maxlength="20" oninput="validar(this)">
		<br/>
        <label for="CVV" class="fa fa-cc-visa" ><b> CVV</b></label>
		<br/>
		<input type="text" name="CVV" class="item_requerid" size="20" maxlength="20" oninput="validar(this)">
        <br/>
