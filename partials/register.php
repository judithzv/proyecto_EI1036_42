...
<div id="mincontainer">
	...
	<form class="fom_usuario" action="?action=registrar" method="POST">
		...
		<br/>
		<input type="text" name="name" class="item_requerid" size="20"  required oninput="validar(this, 40, 'register')">
		<br/>
        <label for="apellidos" class="fa fa-user-o"><b> Apellidos</b></label>
		<br/>
		<input type="text" name="surnames" class="item_requerid" size="20"  required oninput="validar(this, 40, 'register')">
		<br/>
        <label for="usuario" class="fa fa-sign-in" ><b> Usuario</b></label>
		<br/>
		<input type="text" name="username" class="item_requerid" size="20"  required oninput="validar(this, 20, 'register')">
		<br/>
        <label for="passwd" class="fa fa-key" ><b> Contraseña</b></label>
		<br/>
		<input type="password" name="password" class="item_requerid" size="20"  required oninput="validar(this,20, 'register')">
		<br/>
		<label for="email" class="fa fa-envelope"><b> Email</b></label>
		<br/>
		<input type="text" name="mail" class="item_requerid" size="20" required oninput="validar(this, 40, 'register')">
		<br/>
